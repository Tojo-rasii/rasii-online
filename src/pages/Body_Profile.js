      ...
      <div>
        <main className='Profile'>
              ...
              <article>
                <picture className='Profile-img'>
                  ...
                  <article className='article-location'>
                    <p>
                      <strong className='text-primary'>Age:&nbsp;</strong>
                      ___
                    </p>
                    <p>
          ...
          a 15.9155 15.9155 0 0 1 0 -31.831"
                      ...
                      <p className='ms-2'>Creative <span className='fw-bold text-primary'>+80</span></p>
                    </div>
          ...
          a 15.9155 15.9155 0 0 1 0 -31.831"
                      ...
                      <p className=''>Competiteur <span className='fw-bold text-warning'>+90</span></p>
                    </div>
                  </div>
                </div>
              </article>
              ...
              <article>
                <p className='fw-semibold fs-5 text-primary pb-5 content-profile'>
                  ...
                  <div className='mt-1 d-flex flex-column gap-2'>
                    ...
                    <article>
                      <text className='fs-6 text-gris fw-normal'>Defis qui s'intitule</text>
                      <div class="progress">
