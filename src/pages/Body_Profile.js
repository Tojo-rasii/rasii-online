          ...
          <section>
            <article>
              <picture className='Profile-img'>
                ...
                <p className='mt-3 ms-1 text-center border-cv fw-semibold text-primary pt-1 pb-1 rounded-1  fs-6 pe-2' onClick={download}><i className='bi-cloud-arrow-down fs-5' id='i-link'>&nbsp;</i>Curriculum vitae</p>
              </picture>
            </article>
          </section>
