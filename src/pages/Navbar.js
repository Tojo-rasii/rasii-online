  ...
  return (
    <div>
      ...
      <div className='nav_mobile'>
        <header className='naavbar shadow-sm d-flex flex-row justify-content-between align-items-center p-2 pe-5'>
          <NavLink to="/" style={{ textDecoration: 'none' }}><div className='logo pt-1'>
            <p className='para-T h2 fw-bold fs-3'><span className=' fs-2'>T</span><span className='text-danger mt-1 position-absolute'>R.</span></p>
          </div></NavLink>
          <nav>
            <i className='bi-list' id="list" onClick={togg}></i>
            <i className='bi-x' id="close" onClick={togg}></i>
          </nav>
          <section className='mobile_list shadow-lg' style={{ display: active ? "block" : "none" }}>
            ...
            <article>
              <NavLink to="/projets" style={{ textDecoration: 'none' }} className={(nav) => (nav.isActive ? "mobile-active" : "")}>
                <p><i className='bi-pencil-fill i-pencil'></i>&nbsp;&nbsp;Projets</p>
              </NavLink>
            </article>
            <article>
