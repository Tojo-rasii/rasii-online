      ...
      <main className='Apropos'>
          ...
          <header className='shadow-sm p-5'>
            <section>
              <article className='article-text'>
                <sub className='bi-info-circle fw-semibold text-gris fs-6'>&nbsp;{t("about")}</sub>
                <hr className='w-25' />
                <p className='h1 mt-3 fw-bold text-success'>
                  {t("about-title")}</p>
                <p className='text-gris fw-semibold mt-1 ms-1 p-2'>{t("about-desc")}</p>
                <NavLink to="/profile" style={{ textDecoration: "none" }}><button className='btn btn-success d-flex flex-row gap-1 fw-semibold pt-1 mt-2'><span className='bi-person-circle fs-5'>&nbsp;<span className="fs-6">{t("about-btn")}</span></span></button></NavLink>
              </article>
          ...
          <div>
            <section className='d-flex flex-column p-2 rounded-1 outs'>
              ...
              <article className='d-flex flex-column align-items-center text-center'>
                <p className='text-uppercase fw-bold h3 text-primary mt-4 pt-4'>{t("aboutMain-title1")}</p>
                <p className='text-gris p-1 w-75 pb-3 fw-semibold'>{t("aboutMain-desc1")}</p>
            ...
            <section className='d-flex flex-column p-2 rounded-1 outs'>
              ...
              <article className='d-flex flex-column align-items-center'>
                <p className='text-uppercase fw-bold h3 text-warning mt-4 pt-4'>{t("aboutMain-title2")}</p>
                <p className='text-gris w-75 p-1 fw-semibold text-center'>{t("aboutMain-desc2")}</p>
            ...
            <section className='d-flex flex-column p-2 rounded-1 outs'>
              ...
              <article className='d-flex flex-column align-items-center text-center'>
                <p className='text-uppercase fw-bold h3 text-info mt-4 pt-4'>{t("aboutMain-title3")}</p>
                <p className='text-gris w-75 p-1 fw-semibold'>{t("aboutMain-desc3")}</p>
        ...
        <div className='footer-apropos rounded-1 shadow-sm mt-3 pb-5'>
          <section className='pt-3 ps-5'>
            <p className='fw-semibold fs-4 text-center p_right mt-2'>{t("skills")}</p>
            <div className='div-left mt-4 pb-4'>
              ...
              <article className='d-flex flex-column text-center pt-2 pb-1 langage-bg rounded-1'>
                ...
                <p className='h6 mt-3 ms-3'>Git lab</p>
              </article>
              <article className='d-flex flex-column text-center pt-2 pb-1 langage-bg rounded-1'>
                <picture>
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="70" height="70" viewBox="0 0 48 48">
                ...
                <p className='h6 mt-3 ms-3'>PowerPoint</p>
              </article>
              <article className='d-flex flex-column text-center pt-2 pb-1 langage-bg rounded-1'>
                <picture>
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="70" height="70" viewBox="0 0 48 48">
