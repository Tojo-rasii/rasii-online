      ...
      <div className='d-flex flex-row justify-content-between'>
        <main id='mobile-services'>
          ...
          <div class="dialog-1">
            ...
            <p className='m-2 ms-4'>{t("services-title")}</p>
          </div>
        </main>
        <div className='services-title'>
          <p>Mes Services</p>
          <p>Ma priorité absolue est d'offrir des solutions innovantes pour répondre à vos besoins spécifiques.</p>
        </div>
        ...
        <main className='Services'>
          <section>
            ...
            <article>
              <p className='h5 mt-4'>{t("title1")}</p>
          ...
          <section>
            ...
            <article>
              <p className='h5 mt-4'>{t("title2")}</p>
          ...
          <section>
            ...
            <article>
              <p className='h5 mt-4'>{t("title3")}</p>
          ...
          <section>
            ...
            <article>
              <p className='h5 mt-4'>{t("title4")}</p>
