            ...
            <div>
                <main className='Contact d-flex flex-column'>
                    <div className='text-center mt-3'>
                        <p className='h2 fw-bold text-primary'>{t("Contact-title")}</p>
                        <p>{t("Contact-desc")}</p>
                    </div>
                        ...
                        <section className='d-flex flex-column gap-1 p-3'>
                            <article>
                                <picture>
                                    ...
                                    <p className='h4 fw-bold p-2 mt-1'>{t("Contact-title1")}</p>
                                </picture>
                            </article>
                        ...
                        <section className='d-flex flex-column gap-1 p-3'>
                            <article>
                                <picture>
                                    ...
                                    <p className='h4 fw-bold p-2 mt-2'>{t("Contact-title2")}</p>
                                </picture>
                            </article>
                            <article className='p-1'>
                        ...
                        <section className='d-flex flex-column gap-1 p-3'>
                            <article>
                                <picture>
                                    ...
                                    <p className='h4 fw-bold p-2 mt-1'>{t("Contact-title3")}</p>
                                </picture>
                            </article>
                            <article className='p-1'>
